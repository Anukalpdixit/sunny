  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-sans">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-[1024px] flex overflow-hidden h-[650px]">
        ...
        <div className="w-1/2 p-6 lg:p-8 flex flex-col overflow-y-auto border-r border-slate-100">
          ...
          <div className="mb-6">
            <p className="text-xs font-medium text-slate-500 mb-2">Step 3 of 3</p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-base font-bold text-slate-900">Provide Examples</h2>
              </div>
              ...
              <div className="border border-dashed border-slate-300 rounded-xl p-4 flex flex-col items-center justify-center text-center mb-4 hover:bg-slate-50 transition-colors cursor-pointer">
                ...
                <p className="text-[10px] text-slate-500">PDF, DOCX, or TXT (Max 5MB)</p>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
              <div className="flex items-center gap-2 mb-5">
                ...
                <h2 className="text-base font-bold text-slate-900">Adjust Tone</h2>
              </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  {!isAnalyzed ? (
                    <div className="w-full h-2 bg-slate-100 rounded-lg"></div>
                  ) : (
                    <input type="range" min="0" max="100" value={tone1} onChange={(e) => setTone1(Number(e.target.value))} className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-yellow-500" />
                  )}
                </div>
                ...
                <div>
                  ...
                  {!isAnalyzed ? (
                    ...
                    <input type="range" min="0" max="100" value={tone2} onChange={(e) => setTone2(Number(e.target.value))} className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-yellow-500" />
                  )}
                </div>
                ...
                <div>
                  ...
                  {!isAnalyzed ? (
                    ...
                    <input type="range" min="0" max="100" value={tone3} onChange={(e) => setTone3(Number(e.target.value))} className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-yellow-500" />
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-base font-bold text-slate-900">Do's & Don'ts</h2>
              </div>
              
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-medium text-slate-700 mb-1">Words to use often</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-700 mb-1">Words to AVOID</label>
                  <input 
                    type="text" 
        ...
        <div className="w-1/2 bg-slate-50 flex flex-col relative">
          ...
          <div className="flex-1 p-6 overflow-y-auto flex flex-col gap-6">
            {chatStage === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center opacity-50">
                ...
                <p className="text-sm text-slate-500">Upload examples and click Analyze<br/>to start training SUNNY.</p>
              </div>
            )}
            ...
            {chatStage >= 1 && (
              <div className="flex flex-col gap-2">
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-yellow-400 rounded-full flex items-center justify-center text-slate-900 flex-shrink-0 mt-1">
                ...
                {chatStage === 1 && (
                  <div className="flex gap-2 ml-9 mt-1">
                    ...
                    <button 
                      ...
                      className="px-3 py-1.5 bg-yellow-400 text-slate-900 rounded-lg text-xs font-medium hover:bg-yellow-500 transition-colors shadow-sm"
                    >
                      Yes, generate a post
                    </button>
                  </div>
            ...
            {chatStage >= 2 && chatStage !== 3 && (
              <>
                ...
                <div className="flex gap-3 justify-end">
                  <div className="bg-slate-800 text-white rounded-2xl rounded-tr-none p-4 max-w-[85%] shadow-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl rounded-tl-none p-4 max-w-[95%] shadow-sm">
                    ...
                    <div className="border border-slate-200 rounded-xl p-4 mb-4">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <div>
                          <h4 className="text-xs font-bold text-slate-900">Your Brand</h4>
                      ...
                      <div className="w-full h-32 rounded-lg bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500"></div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button className="px-3 py-1.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-lg text-xs font-medium flex items-center gap-1.5 hover:bg-emerald-100 transition-colors">
                        <ThumbsUp className="w-3.5 h-3.5" /> Looks good
                      </button>
                      <button className="px-3 py-1.5 bg-white border border-slate-200 text-slate-700 rounded-lg text-xs font-medium hover:bg-slate-50 transition-colors">
                        More professional
                      </button>
                      <button className="px-3 py-1.5 bg-white border border-slate-200 text-slate-700 rounded-lg text-xs font-medium hover:bg-slate-50 transition-colors">
                        Too many emojis
          ...
          <div className="p-4 border-t border-slate-200 bg-white">
            <div className="relative">
              <input 
                ...
                className="w-full pl-4 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-colors disabled:opacity-50"
              />
              <button 
                disabled={chatStage === 0}
                className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-yellow-400 rounded-lg flex items-center justify-center text-slate-900 hover:bg-yellow-500 transition-colors disabled:opacity-50"
              >
          ...
          <div className="p-4 bg-white border-t border-slate-200">
            <button onClick={onNext} className="w-full py-3 bg-yellow-400 text-slate-900 rounded-xl text-sm font-bold hover:bg-yellow-500 transition-colors shadow-sm">
