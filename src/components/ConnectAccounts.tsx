    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-sans">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-[922px] flex overflow-hidden h-[610px]">
        ...
        <div className="w-full p-6 lg:p-10 flex flex-col overflow-y-auto">
          ...
          <p className="text-slate-500 text-xs mb-4">Grant SUNNY permissions to schedule posts and analyze performance across your platforms.</p>

          {/* Channels Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            
            {/* Instagram - Connected */}
            <div className="border-2 border-emerald-500 rounded-xl p-4 relative bg-emerald-50/10">
            ...
            {/* X (Twitter) - Warning */}
            <div className="border-2 border-yellow-400 rounded-xl p-4 relative bg-yellow-50/30">
          ...
          {/* Info Box */}
          <div className="bg-yellow-50 border border-yellow-100 rounded-xl p-4 flex gap-3 mb-6">
