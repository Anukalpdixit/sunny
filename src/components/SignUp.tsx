      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-5xl flex overflow-hidden min-h-[600px]">
        ...
        <div className="hidden lg:block w-1/2 bg-slate-50 p-10 relative overflow-hidden">
          ...
          <div className="relative h-full flex flex-col justify-between z-10">
            <div className="bg-white/80 backdrop-blur-sm pl-[18px] mr-2 mb-[39px] pb-[21px] pt-[40px] pr-[23px] rounded-2xl shadow-sm border border-white">
            ...
            <div className="mt-8 relative">
              {/* Abstract UI Mockup */}
              <div className="bg-white rounded-t-2xl shadow-lg border border-slate-200 p-4 h-64 overflow-hidden relative">
